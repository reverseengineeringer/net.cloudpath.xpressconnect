...
public class BufferedDecoder
{
  ...
  public int processByte(byte paramByte, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (j == k)
    {
      m = this.translator.decode(this.buf, 0, this.buf.length, paramArrayOfByte, paramInt);
      this.bufOff = 0;
    }
    return m;
  }
  ...
  public int processBytes(byte[] paramArrayOfByte1, int paramInt1, int paramInt2, byte[] paramArrayOfByte2, int paramInt3)
  {
    ...
    if (paramInt2 > i)
    {
      ...
      int k = 0 + this.translator.decode(this.buf, 0, this.buf.length, paramArrayOfByte2, paramInt3);
      this.bufOff = 0;
      int m = paramInt2 - i;
      int n = paramInt1 + i;
      int i1 = paramInt3 + k;
      int i2 = m - m % this.buf.length;
      j = k + this.translator.decode(paramArrayOfByte1, n, i2, paramArrayOfByte2, i1);
      paramInt2 = m - i2;
      paramInt1 = n + i2;
    }
    if (paramInt2 != 0)
