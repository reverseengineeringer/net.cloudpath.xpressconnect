...
public class NamedCurve
{
  ...
  static ECDomainParameters getECParameters(int paramInt)
  {
    int i = paramInt - 1;
    ...
    {
      return null;
      localX9ECParameters = SECNamedCurves.getByName(curveNames[i]);
    }
    while (localX9ECParameters == null);
    return new ECDomainParameters(localX9ECParameters.getCurve(), localX9ECParameters.getG(), localX9ECParameters.getN(), localX9ECParameters.getH(), localX9ECParameters.getSeed());
  }
}